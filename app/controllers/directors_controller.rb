class DirectorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @director.save
        format.html { redirect_to director_url(@director), notice: "Diretor cadastrado com sucesso." }
  ...
  def update
    respond_to do |format|
      if @director.update(director_params)
        format.html { redirect_to director_url(@director), notice: "Dados atualizados com sucesso." }
        format.json { render :show, status: :ok, location: @director }
      else
        format.html {

          render :edit, status: :unprocessable_entity }
        format.json { render json: @directors.errors, status: :unprocessable_entity }
      end
    end
  end
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to directors_url, notice: "Registro apagado com sucesso" }
